setwd("C:/Users/User/OneDrive/Masaüstü/BBall/Portfolio/reports/tables")
...
# 🔧 Step 1: Load CSV
# ───────────────────────────────────────────────
file_path <- "C:/Users/User/OneDrive/Masaüstü/BBall/Portfolio/reports/tables/Tarik PHILLIP.csv"
...
combined_data <- tibble::tibble(
  ...
  Metric = c(
    ...
    "Steal Rate", "Block Rate", "Defensive Rebounding Rate", # Defense (5)
  ...
  PCTL = c(
    ...
    pull(df, `PERCENTILE...89`), pull(df, `PERCENTILE...93`), pull(df, `PERCENTILE...103`),  # STL%, BLK%, DRB%
